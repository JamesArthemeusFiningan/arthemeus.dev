<x-app-layout :page="$page">
    <div class="art-heroine-outer min-h-screen text-white flex items-center">
        <div class="art-heroine-container art-ct art-ct-lg">
            <div class="art-heroine-content max-w-3xl">
                <h1 class="art-title text-5xl md:text-7xl lg:text-8xl font-black">Hi 👋 My name is <a class="text-gay" href="mailto:jason@kpunkt.ch">Jason</a>.</h1>
                ...
                <div class="art-heroine-buttons flex mt-12 text-fliess flex-wrap gap-8 md:gap-16">
