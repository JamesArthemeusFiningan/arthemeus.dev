    ...
    <div class="art-heroine-outer min-h-screen text-white flex items-center">
        <div class="art-heroine-container art-ct art-ct-lg">
            <div class="art-heroine-content max-w-3xl py-20">
                <h1 class="art-title text-5xl md:text-7xl lg:text-8xl font-black">Hi <span class="art-welcome-emoji rotate-12 inline-block animate-shake">👋</span> My name is <a class="text-gay" href="mailto:jason@kpunkt.ch">Jason</a>.</h1>
